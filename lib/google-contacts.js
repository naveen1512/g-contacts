...
GoogleContacts.prototype.getContacts = function (options, callback) {
    ...
    var requestOptions = {
        ...
        method : "GET",
        timeout: 10000,
        headers: options.headers ? lodash.defaults(DEFAULT_HEADERS, options.headers) : DEFAULT_HEADERS,
...
/**
 * Set user credentials. If you provide a refresh_token and expiry_date (milliseconds since the Unix Epoch) and the
